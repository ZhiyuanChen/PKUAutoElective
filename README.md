...
北大选课网 **补退选** 阶段自动选课小工具 v6.0.1 (2021.09.11)

目前支持 `本科生（含辅双）` 和 `研究生` 选课

## 更新说明

小白兔（@zhongxinghong）是本项目的原始作者，他于2021年毕业之后，@Chiyun-CHU 和 @sizhelee 在原项目上进行了改进并提出了PKUAutoElective_update。我们将他们的改进合并进本项目并在他们基础上进行改进。
